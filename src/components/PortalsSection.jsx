          ...
          <div className="grid-2 about-grid">
            <div>
              <span className="section-subtitle">
                UK RESEARCH & PRACTICE NETWORK
              </span>
              <h2 className="section-title text-left">
                ABOUT ANABOLIC STEROIDS UK (ASUK)
              </h2>
              <p className="lead-paragraph">
                Founded in 2017 by leading academics and healthcare
                practitioners, ASUK is an independent, non-profit academic
                network dedicated to the study of Image and Performance
                Enhancing Drugs (IPEDs).
              </p>
              <p className="body-paragraph">
                We believe that criminalization and stigmatization fail to
                reduce drug-related harm. Our objective is to generate rigorous
                scientific evidence, educate clinical staff, inform public
                policy, and empower users with objective health data.
              </p>
            ...
            <div className="about-image-card">
              <div className="asuk-card highlight-box">
                ...
                <ul className="ethical-list">
                  <li>
                    <strong>Zero Stigma Policy:</strong> We treat non-medical
                    IPED users as autonomous individuals deserving of
                    non-judgmental healthcare.
                  </li>
                  <li>
                    <strong>Conflict of Interest Independence:</strong> ASUK
                    does not accept commercial funding from underground steroid
                    manufacturers or unverified supplement brands.
                  </li>
                  <li>
                    <strong>Collaborative Science:</strong> Open access to
                    research methodologies and findings for international harm
                    reduction networks.
                  </li>
                </ul>
              </div>
        ...
        <div className="container">
          <div className="section-header">
            ...
            <h2 className="section-title">
              ACADEMICS & PRACTITIONERS RESOURCES
            </h2>
            <p className="section-desc">
              Tailored information portals for university researchers, NHS
              clinicians, endocrinologists, and NSP harm reduction workers.
            </p>
          </div>
          ...
          <div className="grid-2 portals-grid">
            ...
            <div className="asuk-card portal-card" id="academics-card">
              ...
              <p>
                Access raw anonymized UK survey datasets, ethically approved
                recruitment channels for your studies, peer-review collaboration
                opportunities, and grant co-application frameworks.
              </p>
              <ul className="portal-check-list">
                <li>
                  Ethics clearance templates for IPED human subject studies
                </li>
              ...
              <button
                ...
                onClick={() =>
                  handleNavClick("research", "calls-for-participants")
                }
              >
            ...
            <div className="asuk-card portal-card" id="practitioners-card">
              ...
              <p>
                Evidence-based toolkits for primary care physicians, needle
                syringe programs, and substance misuse services. Includes blood
                test diagnostic thresholds, ASIH treatment guidelines, and
                injection site complication management.
              </p>
              <ul className="portal-check-list">
                <li>
                  NHS Bloodwork Diagnostic Flowcharts (Lipids, Hormones, Liver)
                </li>
      ...
      <section className="section-padding" id="resources">
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-desc">
              Download clinical harm reduction guides, access testing lab
              directories, or request ASUK expert consultation for your health
              service.
            </p>
          </div>
          ...
          <div className="grid-3 resources-grid" id="services">
            <div className="asuk-card res-card">
              ...
              <p>
                Comprehensive clinician guide for interpreting lipid panels,
                hematocrit, total/free testosterone, and liver enzymes in active
                AAS users.
              </p>
              <button
                className="btn-outline mini-btn"
                onClick={() =>
                  alert("Downloading Bloodwork Interpretation Guide PDF...")
                }
              >
                DOWNLOAD PDF (2.4MB)
              </button>
            ...
            <div className="asuk-card res-card">
              ...
              <p>
                Illustrated sterile technique manual detailing gluteal,
                ventrogluteal, and deltoid injection protocols to prevent
                abscess formation and nerve damage.
              </p>
              <button
                className="btn-outline mini-btn"
                onClick={() =>
                  alert("Downloading Injection Safety Guide PDF...")
                }
              >
                DOWNLOAD PDF (1.8MB)
              </button>
            ...
            <div className="asuk-card res-card">
              ...
              <p>
                Needle exchange training, workplace IPED seminars, and public
                health policy consultation for NHS Trusts and Local Authorities.
              </p>
              <button
                className="btn-primary mini-btn"
      ...
      <section className="section-padding bg-surface-dark" id="partners">
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-desc">
              ASUK works in close alignment with global harm reduction bodies,
              European research collectives, and international academic
              institutions.
            </p>
          </div>
